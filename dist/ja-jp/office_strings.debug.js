...
Strings.OfficeOM.L_ConfirmDialog = "ドメイン {0}はMicrosoft Officeとして機能しており、個人データにアクセスできる Office アドインを実行できます。ドメインを Office として実行し、データにアクセスすることが信頼できる場合は、[OK] をクリックして続行してください。";
Strings.OfficeOM.L_ConfirmDialogApiTrustsParent = "{0}から機密情報の送受信を行います。機密情報を受信している次の Web サイトを信頼する場合にのみ、[OK] をクリックしてください: {1}。";
...
Strings.OfficeOM.L_DocumentIsInactive = "このアドインを含むドキュメントが非アクティブであるため、操作に失敗しました。";
...
Strings.OfficeOM.L_ModalDialogOpeng = "このアドインにはアクティブなモーダル ダイアログが既に存在するため、操作に失敗しました。";
