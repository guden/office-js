...
_u.ExtensibilityStrings.l_API_Not_Supported_For_Shared_Folders_Error = "API не підтримується для спільних папок.";
...
_u.ExtensibilityStrings.l_Attachment_Download_Failed_Generic_Error = "Не вдалося завантажити вкладення.";
_u.ExtensibilityStrings.l_Attachment_Resource_Not_Found = "Не вдалося знайти вкладення.";
_u.ExtensibilityStrings.l_Attachment_Resource_UnAuthorizedAccess = "Несанкціонований доступ до вкладення.";
...
_u.ExtensibilityStrings.l_ItemNotFound_Text = "Елемент не існує, або його не створено.";
_u.ExtensibilityStrings.l_Item_Not_Saved_Error_Text = "Щоб отримати ідентифікатор, спочатку збережіть елемент.";
_u.ExtensibilityStrings.l_KeyNotFound_Text = "Указаний ключ не знайдено.";
...
_u.ExtensibilityStrings.l_Missing_Extended_Permissions_For_API = "Відсутній розширений дозвіл для виклику API.";
...
_u.ExtensibilityStrings.l_OnlineMeetingsUserDenied_Text = "Користувачу відмовлено";
...
_u.ExtensibilityStrings.l_SessionDataObjectMaxLengthExceeded_Text = 'Довжина об’єкта "sessionData" перевищила максимальну кількість символів: "{0}".';
_u.ExtensibilityStrings.l_TokenAccessDeniedWithoutItemContext_Text = "Маркер REST доступний лише з дозволом ReadWriteMailbox, якщо відсутній контекст елемента.";