...
Strings.OfficeOM.L_ModalDialogOpeng = "Операция сәтсіз аяқталды, себебі бұл қондырмада белсенді модальды диалогтық терезе бұрыннан бар.";
...
Strings.OfficeOM.L_RequestPayloadSizeLimitExceededMessage = 'Сұраудың пайдалы деректер өлшемі шегінен асып кетті. Келесі құжаттаманы қараңыз: "https://docs.microsoft.com/office/dev/add-ins/concepts/resource-limits-and-performance-optimization#excel-add-ins".';
...
Strings.OfficeOM.L_ResponsePayloadSizeLimitExceededMessage = 'Жауаптың пайдалы деректер өлшемі шегінен асып кетті. Келесі құжаттаманы қараңыз: "https://docs.microsoft.com/office/dev/add-ins/concepts/resource-limits-and-performance-optimization#excel-add-ins".';
