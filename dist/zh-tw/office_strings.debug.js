...
Strings.OfficeOM.L_ConfirmDialog = "網域{0}做為Microsoft Office，而且可以執行可存取您個人資料的 Office 增益集。如果您信任網域以 Office 身分執行並存取您的資料，請按一下 [確定] 繼續。";
Strings.OfficeOM.L_ConfirmDialogApiTrustsParent = "您將從 {0} 發送和接收潛在敏感性資訊。只有在您信任以下接收敏感性資訊的網站時才按一下 [確定]: {1}。";
...
Strings.OfficeOM.L_DialogParentIsMinimized = "作業失敗，因為父視窗已最小化。";
Strings.OfficeOM.L_DialogRequireHTTPS = "不支援 HTTP 通訊協定。請改用 HTTPS";
Strings.OfficeOM.L_DisplayDialogError = "顯示對話方塊錯誤";
Strings.OfficeOM.L_DocumentIsInactive = "作業失敗，因為包含此增益集的文件閒置中。";
...
Strings.OfficeOM.L_ModalDialogOpeng = "作業失敗，因為此增益集已有使用中的強制回應對話方塊。";
...
Strings.OfficeOM.L_RequestPayloadSizeLimitExceededMessage = '要求承載大小已超過限制。請參閱文件: "https://docs.microsoft.com/office/dev/add-ins/concepts/resource-limits-and-performance-optimization#excel-add-ins"。';
Strings.OfficeOM.L_RequestTimeout = "呼叫執行耗時過長。";
Strings.OfficeOM.L_RequestTokenUnavailable = "已節流此 API 減緩呼叫頻率。";
Strings.OfficeOM.L_ResponsePayloadSizeLimitExceededMessage = '回應承載大小已超過限制。請參閱文件: "https://docs.microsoft.com/office/dev/add-ins/concepts/resource-limits-and-performance-optimization#excel-add-ins"。';
