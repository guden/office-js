...
_u.ExtensibilityStrings.l_API_Not_Supported_For_Shared_Folders_Error = "Η διασύνδεση API δεν υποστηρίζεται για κοινόχρηστους φακέλους.";
...
_u.ExtensibilityStrings.l_Attachment_Download_Failed_Generic_Error = "Η λήψη του συνημμένου απέτυχε.";
_u.ExtensibilityStrings.l_Attachment_Resource_Not_Found = "Το συνημμένο δεν βρέθηκε.";
_u.ExtensibilityStrings.l_Attachment_Resource_UnAuthorizedAccess = "Μη εξουσιοδοτημένη πρόσβαση στο συνημμένο.";
...
_u.ExtensibilityStrings.l_KeyNotFound_Text = "Το καθορισμένο κλειδί δεν βρέθηκε.";
...
_u.ExtensibilityStrings.l_OnlineMeetingsUserDenied_Text = "Άρνηση χρήστη.";
...
_u.ExtensibilityStrings.l_SessionDataObjectMaxLengthExceeded_Text = "Το αντικείμενο \"sessionData\" υπερέβη το μέγιστο μήκος '{0}' χαρακτήρων.";
