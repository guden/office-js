...
Strings.OfficeOM.L_ModalDialogOpeng = "Η λειτουργία απέτυχε, επειδή αυτό το πρόσθετο έχει ήδη ένα ενεργό αποκλειστικό παράθυρο διαλόγου.";
...
Strings.OfficeOM.L_RequestPayloadSizeLimitExceededMessage = 'Το μέγεθος ωφέλιμου φορτίου αίτησης έχει υπερβεί το όριο. Ανατρέξτε στην τεκμηρίωση: "https://docs.microsoft.com/office/dev/add-ins/concepts/resource-limits-and-performance-optimization#excel-add-ins".';
...
Strings.OfficeOM.L_ResponsePayloadSizeLimitExceededMessage = 'Το μέγεθος ωφέλιμου φορτίου απόκρισης έχει υπερβεί το όριο. Ανατρέξτε στην τεκμηρίωση: "https://docs.microsoft.com/office/dev/add-ins/concepts/resource-limits-and-performance-optimization#excel-add-ins".';
