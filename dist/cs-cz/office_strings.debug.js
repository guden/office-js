...
Strings.OfficeOM.L_ConfirmDialog = "Doména {0} funguje jako Microsoft Office a může spouštět doplňky pro Office, které mají přístup k vašim osobním údajům. Pokud důvěřujete tomu, že doména běží funguje jako Office a má přístup k vašim datům, pokračujte kliknutím na OK.";
Strings.OfficeOM.L_ConfirmDialogApiTrustsParent = "Chystáte se odeslat a přijmout potenciálně citlivé informace z {0}. Klikněte na tlačítko OK pouze v případě, že důvěřujete následujícímu webu, který přijímá citlivé informace: {1}.";
...
Strings.OfficeOM.L_DialogParentIsMinimized = "Operace se nezdařila, protože nadřazené okno je minimalizované.";
...
Strings.OfficeOM.L_DocumentIsInactive = "Operace se nezdařila, protože dokument obsahující tento doplněk je neaktivní.";
...
Strings.OfficeOM.L_ModalDialogOpeng = "Operace se nepovedla, protože tento doplněk už má aktivní modální dialogové okno.";
...
Strings.OfficeOM.L_RequestPayloadSizeLimitExceededMessage = "Velikost datové části žádosti překročila limit. Přečtěte si dokumentaci: https://docs.microsoft.com/office/dev/add-ins/concepts/resource-limits-and-performance-optimization#excel-add-ins.";
...
Strings.OfficeOM.L_ResponsePayloadSizeLimitExceededMessage = "Velikost datové části odpovědi překročila limit. Přečtěte si dokumentaci: https://docs.microsoft.com/office/dev/add-ins/concepts/resource-limits-and-performance-optimization#excel-add-ins.";
