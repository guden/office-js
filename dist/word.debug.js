...
(function (Office) {
    ...
    (function (context) {
        ...
        (function (extensionLifeCycle) {
            function launchExtensionComponent(params) {
                ...
                if (hostInfo.hostPlatform == OSF.HostInfoPlatform.web) {
                    ...
                    webAppState.clientEndPoint.invoke("ContextActivationManager_notifyHost", null, [webAppState.id, OSF.AgaveHostAction.LaunchExtensionComponent, params]);
                }
                else {
                    throw OSF.Utility.createNotImplementedException();
                }
            }
            extensionLifeCycle.launchExtensionComponent = launchExtensionComponent;
            function stopExtensionComponent(params) {
                var hostInfo = OSF._OfficeAppFactory.getHostInfo();
                if (hostInfo.hostPlatform == OSF.HostInfoPlatform.web) {
                    var webAppState = OSF._OfficeAppFactory.getWebAppState();
                    webAppState.clientEndPoint.invoke("ContextActivationManager_notifyHost", null, [webAppState.id, OSF.AgaveHostAction.StopExtensionComponent, params]);
                }
                else {
                    throw OSF.Utility.createNotImplementedException();
                }
            }
            extensionLifeCycle.stopExtensionComponent = stopExtensionComponent;
            function restartExtensionComponent(params) {
                var hostInfo = OSF._OfficeAppFactory.getHostInfo();
                if (hostInfo.hostPlatform == OSF.HostInfoPlatform.web) {
                    var webAppState = OSF._OfficeAppFactory.getWebAppState();
                    webAppState.clientEndPoint.invoke("ContextActivationManager_notifyHost", null, [webAppState.id, OSF.AgaveHostAction.RestartExtensionComponent, params]);
                }
                else {
                    throw OSF.Utility.createNotImplementedException();
                }
            }
            extensionLifeCycle.restartExtensionComponent = restartExtensionComponent;
        })(extensionLifeCycle = context.extensionLifeCycle || (context.extensionLifeCycle = {}));
...
(function (OfficeExtension_1) {
    ...
    var CoreErrorCodes = (function () {
        ...
        CoreErrorCodes.responsePayloadSizeLimitExcceded = 'ResponsePayloadSizeLimitExcceded';
    ...
    var RichApiMessageUtility = (function () {
        ...
        RichApiMessageUtility.buildResponseOnError = function (errorCode, message) {
            ...
            if (errorCode == RichApiMessageUtility.OfficeJsErrorCode_ooeNoCapability) {
                ...
                response.ErrorCode = CoreErrorCodes.responsePayloadSizeLimitExcceded;
                response.HttpStatusCode = 400;
            }
...
(function (OfficeCore) {
    ...
    var _libraryMetadataOfficeSharedApi = { "version": "1.0.0",
        ...
        "enumTypes": [["IdentityType", ["organizationAccount", "microsoftAccount", "unsupported"]],
            ...
            ["SharedFilePickerLandingLocation", ["myFiles", "recent", "currentFolder"]]],
        "clientObjectTypes": [[1,
                4,
                0,
                [["roamingSettings",
...
(function (Word) {
    ...
    function isSearchFlagsSupported() {
        if (typeof (window) !== "undefined" && window.Office && window.Office.context && window.Office.context.requirements) {
            return window.Office.context.requirements.isSetSupported("WordApiSearchFlags", "1.1");
        }
        return false;
    }
    function _getSearchFlags(searchOptions) {
        if (OfficeExtension.Utility.isNullOrUndefined(searchOptions)) {
            return 0;
        }
        if (typeof (searchOptions) != "object") {
        ...
        if (searchOptions.ignorePunct) {
            searchFlags |= 32;
        }
        if (searchOptions.ignoreSpace) {
            searchFlags |= 64;
        }
        if (searchOptions.matchCase) {
            searchFlags |= 1;
        }
        if (searchOptions.matchPrefix) {
            searchFlags |= 8;
        }
        if (searchOptions.matchSuffix) {
            searchFlags |= 16;
        }
        if (searchOptions.matchWildcards) {
            searchFlags |= 4;
        }
    ...
    (function (_CC) {
        function Body_Search(thisObj, searchText, searchOptions) {
            var result;
            if (isSearchFlagsSupported()) {
                var searchFlags = _getSearchFlags(searchOptions);
                result = thisObj._Search2(searchText, searchFlags);
            }
            else {
                searchOptions = _normalizeSearchOptions(thisObj.context, searchOptions);
                result = _createMethodObject(Word.RangeCollection, thisObj, "Search", 1, [searchText, searchOptions], true, false, null, 4);
            }
    ...
    var _libraryMetadataWdJscomApi = { "version": "1.0.0",
        ...
        "hostName": "Word",
        "apiSets": [["1.3"], ["1.2", "WordOnline"], ["1.2"], ["1.4"], ["1.1", "WordOnline"], ["1.3", "WordApiHiddenDocument"], ["1.4", "WordApiHiddenDocument"]],
        "strings": ["Annotation", "AnnotationCollection", "Application", "Body", "Comment", "CommentCollection", "CommentReply", "CommentReplyCollection", "ContentControl", "ContentControlCollection", "CustomProperty", "CustomPropertyCollection", "CustomXmlPart", "CustomXmlPartCollection", "CustomXmlPartScopedCollection", "Document", "DocumentCreated", "DocumentProperties", "Font", "InlinePicture", "InlinePictureCollection", "List", "ListCollection", "ListItem", "NoteItem", "NoteItemCollection", "Paragraph", "ParagraphCollection", "Range", "RangeCollection", "SearchOptions", "Section", "SectionCollection", "Setting", "SettingCollection", "Table", "TableCollection", "TableRow", "TableRowCollection", "TableCell", "TableCellCollection", "TableBorder", "content", "id", "_ReferenceId", "_KeepReference", "delete", "getItem", "getFirst", "getFirstOrNullObject", "this._ReferenceId", "_RegisterDeletedEvent", "_UnregisterDeletedEvent", "style", "text", "type", "styleBuiltIn", "paragraphs", "contentControls", "parentContentControl", "font", "inlinePictures", "parentBody", "lists", "tables", "parentContentControlOrNullObject", "footnotes", "endnotes", "insertBreak", "clear", "getHtml", "getOoxml", "select", "insertText", "insertHtml", "insertOoxml", "insertParagraph", "insertContentControl", "insertFileFromBase64", "insertInlinePictureFromBase64", "search", "getRange", "insertTable", "_Search2", "getComments", "authorEmail", "authorName", "creationDate", "title", "color", "parentTableCell", "parentTable", "parentTableCellOrNullObject", "parentTableOrNullObject", "split", "getTextRanges", "getById", "getByIdOrNullObject", "key", "value", "_Id", "getCount", "deleteAll", "add", "getItemOrNullObject", "saved", "sections", "body", "properties", "settings", "customXmlParts", "save", "deleteBookmark", "getMetadata", "setMetadata", "getBookmarkRange", "getBookmarkRangeOrNullObject", "hyperlink", "width", "getNext", "getNextOrNullObject", "_GetItem", "alignment", "values", "shadingColor", "horizontalAlignment", "verticalAlignment", "getCellPadding", "setCellPadding", "getBorder", "rowIndex", "insertRows"],
        "enumTypes": [["NoteItemType", ["footnote", "endnote"]],
            ["NumericEventType", [], { "contentControlDeleted": 0, "contentControlSelectionChanged": 1, "contentControlDataChanged": 2, "contentControlAdded": 3, "annotationAdded": 4, "annotationChanged": 5, "annotationDeleted": 6 }],
            ...
            ["BodyType", ["unknown", "mainDoc", "section", "header", "footer", "tableCell", "footnote", "endnote", "noteItem"]],
