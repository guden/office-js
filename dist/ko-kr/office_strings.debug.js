...
Strings.OfficeOM.L_ConfirmDialog = "도메인 {0} Microsoft Office 역할을 하며 개인 데이터에 액세스할 수 있는 Office 추가 기능을 실행할 수 있습니다. Office로 실행할 도메인을 신뢰하고 데이터에 액세스하는 경우 [확인]을 클릭하여 계속하세요.";
...
Strings.OfficeOM.L_DialogParentIsMinimized = "부모 창이 최소화되어 작업이 실패했습니다.";
...
Strings.OfficeOM.L_DocumentIsInactive = "이 추가 기능이 포함된 문서가 비활성 상태이므로 작업이 실패했습니다.";
...
Strings.OfficeOM.L_ModalDialogOpeng = "이 추가 기능에 이미 활성 모달 대화 상자가 있으므로 작업이 실패했습니다.";
