...
_u.ExtensibilityStrings.l_API_Not_Supported_For_Shared_Folders_Error = "API não compatível com pastas compartilhadas.";
...
_u.ExtensibilityStrings.l_Attachment_Download_Failed_Generic_Error = "O download do anexo falhou.";
_u.ExtensibilityStrings.l_Attachment_Resource_Not_Found = "Anexo não encontrado.";
_u.ExtensibilityStrings.l_Attachment_Resource_UnAuthorizedAccess = "O acesso ao anexo não está autorizado.";
...
_u.ExtensibilityStrings.l_KeyNotFound_Text = "A chave especificada não pôde ser encontrada.";
...
_u.ExtensibilityStrings.l_OnlineMeetingsUserDenied_Text = "Usuário negado.";
...
_u.ExtensibilityStrings.l_SessionDataObjectMaxLengthExceeded_Text = "O objeto 'sessionData' ultrapassou seu comprimento máximo de caracteres '{0}'.";
