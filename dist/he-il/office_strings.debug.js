...
Strings.OfficeOM.L_ConfirmDialog = "תחום {0} פועל Microsoft Office ובאפשרותך להפעיל תוספות Office, יכולות לגשת לנתונים האישיים שלך. אם אתה נותן אמון בתחום להפעלה כ- Office ולגשת לנתונים שלך, לחץ על 'אישור' כדי להמשיך.";
...
Strings.OfficeOM.L_DialogParentIsMinimized = "הפעולה נכשלה מאחר שחלון האב ממוזער.";
...
Strings.OfficeOM.L_DocumentIsInactive = "הפעולה נכשלה מכיוון שהמסמך המכיל תוספת זו אינו פעיל.";
...
Strings.OfficeOM.L_ModalDialogOpeng = "הפעולה נכשלה מאחר שתוספת זו כוללת כבר תיבת דו-שיח מודאלית פעילה.";
