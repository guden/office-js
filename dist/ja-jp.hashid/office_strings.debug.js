...
Strings.OfficeOM.L_ConfirmDialog = "［Upu3v］[The domain {0} is acting as Microsoft Office and can run Office add-ins, which can access your personal data. If you trust the domain to run as Office and access your data, click OK to continue.]";
...
Strings.OfficeOM.L_DialogParentIsMinimized = "［0nY0r］[The operation failed because parent window is minimized.]";
...
Strings.OfficeOM.L_DocumentIsInactive = "［Cp0LE］[The operation failed because the document containing this add-in is inactive.]";
...
Strings.OfficeOM.L_ModalDialogOpeng = "［9D9gX］[The operation failed because this add-in already has an active modal dialog.]";
