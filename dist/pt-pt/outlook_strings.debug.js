...
_u.ExtensibilityStrings.l_API_Not_Supported_For_Shared_Folders_Error = "API não é suportada para as pastas partilhadas.";
...
_u.ExtensibilityStrings.l_Attachment_Download_Failed_Generic_Error = "O descarregamento do anexo falhou.";
_u.ExtensibilityStrings.l_Attachment_Resource_Not_Found = "Anexo não encontrado.";
_u.ExtensibilityStrings.l_Attachment_Resource_UnAuthorizedAccess = "Acesso não autorizado ao anexo.";
...
_u.ExtensibilityStrings.l_KeyNotFound_Text = "A chave especificada não foi encontrada.";
...
_u.ExtensibilityStrings.l_OnlineMeetingsUserDenied_Text = "Utilizador recusado.";
...
_u.ExtensibilityStrings.l_SessionDataObjectMaxLengthExceeded_Text = 'O objeto "sessionData" ultrapassou o comprimento máximo de "{0}" carateres.';
_u.ExtensibilityStrings.l_TokenAccessDeniedWithoutItemContext_Text = "Um token REST apenas está disponível com permissão ReadWriteMailbox quando não há contexto de item.";