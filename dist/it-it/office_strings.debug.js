...
Strings.OfficeOM.L_ConfirmDialog = "Il dominio {0} funge da Microsoft Office e può eseguire componenti aggiuntivi di Office, che possono accedere ai tuoi dati personali. Se si considera attendibile il dominio per l'esecuzione come Office e l'accesso ai dati, fare clic su OK per continuare.";
...
Strings.OfficeOM.L_DialogParentIsMinimized = "L'operazione non è riuscita perché la finestra padre è ridotta a icona.";
...
Strings.OfficeOM.L_DocumentIsInactive = "L'operazione non è riuscita perché il documento contenente questo componente aggiuntivo è inattivo.";
...
Strings.OfficeOM.L_ModalDialogOpeng = "L'operazione non è riuscita perché questo componente aggiuntivo dispone già di una finestra di dialogo modale attiva.";
