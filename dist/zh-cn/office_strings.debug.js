...
Strings.OfficeOM.L_ConfirmDialog = "域 {0} 充当 Microsoft Office，可以运行可访问个人数据的 Office 加载项。如果信任域以 Office 身份运行并访问数据，请单击“确定”继续。";
...
Strings.OfficeOM.L_DialogParentIsMinimized = "操作失败，因为父窗口已最小化。";
Strings.OfficeOM.L_DialogRequireHTTPS = "HTTP 协议不受支持。请改用 HTTPS。";
Strings.OfficeOM.L_DisplayDialogError = "显示对话框错误";
Strings.OfficeOM.L_DocumentIsInactive = "操作失败，因为包含此加载项的文档处于非活动状态。";
...
Strings.OfficeOM.L_ModalDialogOpeng = "操作失败，因为此加载项已具有活动模式对话框。";
