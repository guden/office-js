...
_u.ExtensibilityStrings.l_API_Not_Supported_For_Shared_Folders_Error = "API stöds inte för delade mappar.";
...
_u.ExtensibilityStrings.l_Attachment_Download_Failed_Generic_Error = "Nedladdningen av den bifogade filen misslyckades.";
_u.ExtensibilityStrings.l_Attachment_Resource_Not_Found = "Det gick inte att hitta den bifogade filen.";
_u.ExtensibilityStrings.l_Attachment_Resource_UnAuthorizedAccess = "Obehörig åtkomst till den bifogade filen.";
...
_u.ExtensibilityStrings.l_KeyNotFound_Text = "Den specificerade nyckeln hittades inte.";
...
_u.ExtensibilityStrings.l_OnlineMeetingsUserDenied_Text = "Användare nekade.";
...
_u.ExtensibilityStrings.l_SessionDataObjectMaxLengthExceeded_Text = "Objektet ’sessionData’ överskrider maxlängden på ’{0}’ tecken.";
