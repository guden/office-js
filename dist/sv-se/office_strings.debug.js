...
Strings.OfficeOM.L_ConfirmDialog = "Domänen {0} fungerar som Microsoft Office och kan köra Office-tillägg, som har åtkomst till dina personliga uppgifter. Om du litar på att domänen ska köras som Office och komma åt dina data klickar du på OK för att fortsätta.";
Strings.OfficeOM.L_ConfirmDialogApiTrustsParent = "Du håller på att skicka och ta emot känslig information från {0}. Klicka bara på OK om du litar på att följande webbplats får känslig information: {1}.";
...
Strings.OfficeOM.L_DialogParentIsMinimized = "Åtgärden misslyckades eftersom det överordnade fönstret är minimerat.";
...
Strings.OfficeOM.L_DocumentIsInactive = "Åtgärden misslyckades eftersom dokumentet som innehåller det här tillägget är inaktivt.";
...
Strings.OfficeOM.L_ModalDialogOpeng = "Åtgärden misslyckades eftersom det här tillägget redan har en aktiv modal dialogruta.";
...
Strings.OfficeOM.L_RequestPayloadSizeLimitExceededMessage = 'Storleken på begärd nyttolast har överskridit gränsen. Mer information finns i dokumentationen: "https://docs.microsoft.com/office/dev/add-ins/concepts/resource-limits-and-performance-optimization#excel-add-ins".';
...
Strings.OfficeOM.L_ResponsePayloadSizeLimitExceededMessage = 'Storleken på svarets nyttolast har överskridit gränsen. Mer information finns i dokumentationen: "https://docs.microsoft.com/office/dev/add-ins/concepts/resource-limits-and-performance-optimization#excel-add-ins".';
