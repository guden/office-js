...
Strings.OfficeOM.L_ConfirmDialog = "Domenet {0} fungerer som Microsoft Office og kan kjøre Office-tillegg, som har tilgang til personopplysningene dine. Hvis du stoler på at domenet kjører som Office og får tilgang til dataene, klikker du OK for å fortsette.";
Strings.OfficeOM.L_ConfirmDialogApiTrustsParent = "Du er i ferd med å sende og motta potensielt sensitiv informasjon fra {0}. Klikk bare OK hvis du stoler på at følgende nettsted mottar sensitiv informasjon: {1}.";
...
Strings.OfficeOM.L_DialogParentIsMinimized = "Operasjonen mislyktes fordi det overordnede vinduet er minimert.";
...
Strings.OfficeOM.L_DocumentIsInactive = "Operasjonen mislyktes fordi dokumentet som inneholder dette tillegget, er inaktivt.";
...
Strings.OfficeOM.L_ModalDialogOpeng = "Operasjonen mislyktes fordi dette tillegget allerede har en aktiv modal dialogboks.";
