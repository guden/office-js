...
_u.ExtensibilityStrings.l_API_Not_Supported_For_Shared_Folders_Error = "API не поддерживается для общих папок.";
...
_u.ExtensibilityStrings.l_Attachment_Download_Failed_Generic_Error = "Не удалось скачать вложение.";
_u.ExtensibilityStrings.l_Attachment_Resource_Not_Found = "Вложение не найдено.";
_u.ExtensibilityStrings.l_Attachment_Resource_UnAuthorizedAccess = "Несанкционированный доступ к вложению.";
...
_u.ExtensibilityStrings.l_KeyNotFound_Text = "Указанный ключ не найден.";
...
_u.ExtensibilityStrings.l_OnlineMeetingsUserDenied_Text = "Отказ пользователя.";
...
_u.ExtensibilityStrings.l_SessionDataObjectMaxLengthExceeded_Text = "Для объекта 'sessionData' превышена максимальная длина из '{0}' символов.";
