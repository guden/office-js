...
Strings.OfficeOM.L_ColIndexOutOfRange = "El valor de índice de la columna está fuera del rango permitido. Utiliza un valor (0 o superior) que sea menor que el número de columnas.";
Strings.OfficeOM.L_ConfirmCancelMessage = "No podemos continuar.";
Strings.OfficeOM.L_ConfirmDialog = "El dominio {0} actúa como Microsoft Office y puede ejecutar complementos de Office, que pueden acceder a tus datos personales. Si confías en el dominio para ejecutarse como Office y tener acceso a tus datos, haz clic en Aceptar para continuar.";
...
Strings.OfficeOM.L_ModalDialogOpeng = "Error en la operación porque este complemento ya tiene un cuadro de diálogo modal activo.";
