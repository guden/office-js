...
Strings.OfficeOM.L_ConfirmDialog = "Domena, {0} deluje kot Microsoft Office in lahko zažene Officeove dodatke, ki lahko dostopajo do vaših osebnih podatkov. Če zaupate domeni, da se bo izvajala kot Office in dostopala do podatkov, kliknite »V redu« za nadaljevanje.";
Strings.OfficeOM.L_ConfirmDialogApiTrustsParent = "Iz {0} boste pošiljali in prejemali občutljive informacije. Kliknite» v redu «, če v tem spletnem mestu zaupate le občutljive informacije: {1}.";
...
Strings.OfficeOM.L_DialogParentIsMinimized = "Operacija ni uspela, ker je nadrejeno okno minimizirano.";
...
Strings.OfficeOM.L_DocumentIsInactive = "Operacija ni uspela, ker dokument, ki vsebuje ta dodatek, ni dejaven.";
...
Strings.OfficeOM.L_ModalDialogOpeng = "Operacija ni uspela, ker ima ta dodatek že aktivno modalno pogovorno okno.";
